...
class HomomorphicEncryptionService:
    ...
    def __init__(
        ...
        self._create_context(poly_modulus_degree, coeff_mod_bit_sizes, security_level)
    ...
    def _create_context(self, poly_modulus_degree: int, coeff_mod_bit_sizes: List[int], security_level: int) -> None:
        """
        ...
        self.context_params = ts.CKKSParameters(
            poly_modulus_degree=poly_modulus_degree,
            coeff_mod_bit_sizes=coeff_mod_bit_sizes,
            security_level=security_level
        )
        self.context = ts.Context(self.context_params)
